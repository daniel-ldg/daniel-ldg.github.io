...
import { Project, Techs } from "./card/Project";
...
const projects: Project[] = [
	{
		...
		description: [
			...
			},
			{
				...
				paragraphs: [
					"Desarrolle modulo para convertir la compleja estructura de los recibos de nomina en formato CSV a objetos de JavaScript.",
